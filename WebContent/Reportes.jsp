...
<body>
	...
	<%
		...
		if (request.getAttribute("Not") != null) {
			Not = (Notas) request.getAttribute("Not");
		}
		int opcion = 1;
...
<input type=submit name="filtro3" id="sendBtn" value="Reporte 3" />
	...
	<p>Elige un año</p><input name="Año" type="number" min="1980" max="2030" required>
...
<h1>Bienvenido:
	...
	<form method="post" action="Reportes">
		...
		<p>Elije año</p><input name="Ano" type="number" min="1980" max="2030" required>  
...
<h1>Bienvenido:
	...
	<form method="post" action="Reportes">
		...
		<p>Año inicio</p><input name="AñoIni" type="number" min="1980" max="2030" required> 
		<p>Año fin</p><input name="AñoFin" type="number" min="1980" max="2030" required> <br>
